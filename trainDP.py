...
def differentialPrivacy(model):
    ...
    def tokenize_function(examples):
        # Combine the 'Patient' and 'Doctor' dialogues
        conversations = [f"Patient: {patient}\nDoctor: {doctor}" for patient, doctor in zip(examples["Patient"], examples["Doctor"])]
        return tokenizer(conversations, return_tensors="pt", padding=True, truncation=True)
...
if init_from == 'scratch':
    ...
    model = differentialPrivacy(model)
